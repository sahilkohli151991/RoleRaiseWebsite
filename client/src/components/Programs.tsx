import { Check, Zap, Star, Crown, Settings } from 'lucide-react';
    ...
    <section id="programs" className="py-24 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center mb-20">
          ...
          <h2 className="heading-2 mb-6">Accelerate Your Career Journey</h2>
          <p className="body-text-large max-w-3xl mx-auto">
            Choose from our proven programs designed to fast-track your career to $200K+ tech roles
          </p>
